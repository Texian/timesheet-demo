...
export default function Register() {
  return (
    <Layout> {/* Creating a CSS component allows it to both replace the <></> container while applying the specified CSS to everything between */}
      <Head>
      ...
      <Script
        ...
        onLoad={() =>  // 'onLoad' is called immediately after the script has loaded
